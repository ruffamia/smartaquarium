...
<div id="content">
    ...
    <div class="container-fluid">
        ...
        <div class="d-sm-flex align-items-center justify-content-between mb-4">
            <h1 class="h3 mb-0 text-gray-800">AMMONIA LEVEL Data Records</h1>
        </div>
      ...
      <tbody id="tbody_table_record">
        <?php
          ...
          $sql = 'SELECT * FROM table_sensor where ammoniaalert = "SUCCESS" ORDER BY date, time DESC';
          foreach ($pdo->query($sql) as $row) {
            ...
            echo '<td class="bdr">'. $row['ammoniaalert'] . '</td>';
            // echo '<td class="bdr">'. $row['ammonia'] . '</td>';
